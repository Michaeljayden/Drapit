        ...
        <div className="max-w-6xl mx-auto py-8 px-4 md:px-6">
            ...
            >
                <GuideCard
                    ...
                    description="Upload een referentiefoto (bijvoorbeeld van Pinterest of een eigen shoot) en de AI kopieert de stijl: de achtergrond, belichting, sfeer en kleurgrading worden overgenomen."
                />
                <GuideCard
                    label="Stijl-overname"
                    description="Wanneer je een inspiratiebeeld gebruikt, worden handmatige keuzes voor Achtergrond en Belichting genegeerd. De AI focust zich volledig op de 'vibe' van jouw geüploade foto."
                />
                <GuideCard
                    label="Consistentie"
                    description="Gebruik hetzelfde inspiratiebeeld voor al je producten om een consistente look & feel te creëren voor je gehele collectie of webshop."
                />
            </GuideSection>
