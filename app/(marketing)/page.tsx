...
function PlatformLogos() {
    ...
    const logos = [
        {
            name: 'Shopify',
            path: 'M15.337 23.979l7.216-1.561s-2.604-17.613-2.625-17.73c-.018-.116-.114-.192-.211-.192s-1.929-.136-1.929-.136-1.275-1.274-1.439-1.411c-.045-.039-.101-.06-.162-.06-.062 0-.115.021-.157.059-1.393 1.258-2.585 2.339-2.585 2.339s-.144.116-.242.116-.215-.069-.215-.069L7.49 2.573s-.103-.075-.24-.075-.224.09-.224.09-.904.757-1.077.92c-.041.037-.09.055-.145.055-.058 0-.109-.017-.152-.05L2.093 1.341c-.035-.028-.078-.042-.122-.042-.043 0-.083.013-.116.039L.085 2.569c-.066.059-.099.135-.099.227 0 .093.033.17.098.23l1.83 1.642.666-.358s.167-.091.24-.091.218.069.218.069l3.376 3.032s.098.083.21.083.208-.067.208-.067l.95-.506 3.513 7.828s.08.18.2.18c.12 0 .237-.087.237-.087l3.653-7.531.954.508s.162.086.234.086.216-.069.216-.069l1.458-1.31c.04-.036.088-.054.143-.054.058 0 .108.019.149.056l1.246 1.116s.104.093.23.093c.125 0 .235-.08.235-.08l-.208 1.488s.094.137.24.137c.146 0 .272-.112.272-.112l1.623-1.458c.038-.033.082-.05.129-.05.046 0 .089.016.121.047L23.973 22.42c.063.06.095.138.095.234 0 .097-.033.177-.097.238l-7.54 1.628c-.037.008-.073.012-.109.012-.045 0-.089-.009-.13-.023z',
            viewBox: '0 0 24 25'
        },
        {
            name: 'WooCommerce',
        ...
        {
            name: 'Magento',
            path: 'M12 24l-4.14-2.4v-11.4l4.14-2.4 4.14 2.4v11.4l-4.14 2.4zm-6.21-3.6l-5.79-3.35v-10.3l5.79 3.35v10.3zm12.42 0l5.79-3.35v-10.3l-5.79 3.35v10.3z',
            viewBox: '0 0 24 24'
        },
        {
            name: 'Wix',
            path: 'M23.9,13.3c0,0-0.1,0.2-0.3,0.3c-0.2,0.1-0.4,0.1-0.6,0.1c-0.3,0-0.5-0.1-0.7-0.2c-0.2-0.2-0.3-0.4-0.3-0.7c0-0.3,0.1-0.6,0.3-0.8 c0.2-0.2,0.5-0.3,0.8-0.3c0.3,0,0.6,0.1,0.8,0.3c0.2,0.2,0.3,0.5,0.3,0.8C24.1,12.9,24,13.1,23.9,13.3z M19.4,14.6l-0.8-1.7l-0.8,1.7 h-1.5l1.6-3L16.4,8.5h1.5l0.8,1.7l0.8-1.7h1.5l-1.6,3.1l1.6,3.1H19.4z M13.7,14.6V8.5h1.3v6.1H13.7z M10.4,14.6l-1.1-4l-1.1,4H6.8 L5.1,8.5h1.5l1,3.8L8.7,8.5h1.3l1,3.8l1-3.8h1.5l-1.7,6.1H10.4z',
            viewBox: '0 0 24 24'
        },
        {
            name: 'BigCommerce',
            path: 'M21.1,13.4l-1.8,1l-0.9-1.6l1.8-1c0.3-0.2,0.4-0.5,0.3-0.8c-0.1-0.3-0.4-0.5-0.7-0.4l-6.9,3.9l-0.9-1.6l6.9-3.9 c1-0.6,1.4-1.8,0.8-2.8c-0.6-1-1.8-1.4-2.8-0.8l-10,5.7l-0.9-1.6l10-5.7c1.7-1,3.9-0.4,4.9,1.3C22.8,9,22.2,11.2,20.5,12.2z M10.8,18.1 l-6.9,3.9l-0.9-1.6l6.9-3.9c0.3-0.2,0.4-0.5,0.3-0.8c-0.1-0.3-0.4-0.5-0.7-0.4l-1.8,1l-0.9-1.6l1.8-1c1-0.6,1.4-1.8,0.8-2.8 c-0.6-1-1.8-1.4-2.8-0.8l-1.8,1l-0.9-1.6l1.8-1c1.7-1,3.9-0.4,4.9,1.3C13.1,13.7,12.5,15.9,10.8,16.9z',
            viewBox: '0 0 24 24'
        }
    ];
