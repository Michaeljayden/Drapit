    ...
    const PLANS = [
        {
            ...
            features: [
                t('pricing.plans.trial.feature0'),
                t('pricing.plans.trial.feature1'),
                t('pricing.plans.trial.feature2'),
            ],
            popular: false,
        ...
        },
        {
            ...
            features: [
                ...
                t('pricing.plans.starter.feature1'),
                t('pricing.plans.starter.feature2'),
                t('pricing.plans.starter.feature3'),
            ],
            popular: false,
        ...
        },
        {
            ...
            features: [
                ...
                t('pricing.plans.scale.feature1'),
                t('pricing.plans.scale.feature2'),
                t('pricing.plans.scale.feature3'),
                t('pricing.plans.scale.feature4'),
                t('pricing.plans.scale.feature5'),
            ],
            popular: false,
        ...
        },
        {
            ...
            features: [
                ...
                t('pricing.plans.business.feature5'),
            ],
            popular: false,
    ...
    const STUDIO_PLANS = [
        {
            ...
            features: [
                t('studioPricing.plans.trial.feature0'),
                t('studioPricing.plans.trial.feature1'),
                t('studioPricing.plans.trial.feature2'),
                t('studioPricing.plans.trial.feature3'),
            ],
            popular: false,
        ...
        },
        {
            ...
            features: [
                t('studioPricing.plans.starter.feature0'),
                t('studioPricing.plans.starter.feature1'),
                t('studioPricing.plans.starter.feature2'),
                t('studioPricing.plans.starter.feature3'),
                t('studioPricing.plans.starter.feature4'),
            ],
            popular: false,
        ...
        },
        {
            ...
            features: [
                t('studioPricing.plans.pro.feature0'),
                t('studioPricing.plans.pro.feature1'),
                t('studioPricing.plans.pro.feature2'),
                t('studioPricing.plans.pro.feature3'),
                t('studioPricing.plans.pro.feature4'),
                t('studioPricing.plans.pro.feature5'),
            ],
            popular: true,
        ...
        },
        {
            ...
            features: [
                t('studioPricing.plans.scale.feature0'),
                t('studioPricing.plans.scale.feature1'),
                t('studioPricing.plans.scale.feature2'),
                t('studioPricing.plans.scale.feature3'),
                t('studioPricing.plans.scale.feature4'),
                t('studioPricing.plans.scale.feature5'),
            ],
            popular: false,
            ...
            <div style={{ background: '#06090F', minHeight: '100vh' }}>
                ...
                <nav style={{
                    ...
                    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 28px', height: 70, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <div className="d-nav-links" style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                            ...
                            <Link href="/license" className="d-nav-link">License</Link>
                ...
                <div className={`d-mobile-drawer ${mobileMenuOpen ? 'open' : ''}`}>
                    ...
                    <nav style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
                        ...
                        <Link href="/studio" className="d-mobile-drawer-link" onClick={() => setMobileMenuOpen(false)}>Studio</Link>
